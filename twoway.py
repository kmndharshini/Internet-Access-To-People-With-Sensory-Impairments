...
op_dest = "C:/Users/91944/PycharmProjects/test webcam/filtered_data/";
alpha_dest="C:/Users/91944/PycharmProjects/test webcam/alphabet/";
...
class StartPage(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        label = tk.Label(self, text="Sign Langage Translator", font=("Helvetica", 12))
        ...
        load = PIL.Image.open("C:/Users/91944/PycharmProjects/test webcam/wallpaper.png")
...
class StoV(tk.Frame):
    ...
    def __init__(self, parent, controller):
        ...
        label.pack(pady=10, padx=10)
        load = PIL.Image.open("C:/Users/91944/PycharmProjects/test webcam/w1.png")
        load = load.resize((800, 450))
        render = ImageTk.PhotoImage(load)
        img = Label(self, image=render)
        img.image = render
        img.place(x=250, y=190)
        button1 = tk.Button(self, text="Back to Home", command=lambda: controller.show_frame(StartPage))
        button1.pack(pady=10, padx=10)

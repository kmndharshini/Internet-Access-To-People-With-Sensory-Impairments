...
classifier = cv2.CascadeClassifier('C:/Users/91944/PycharmProjects/test webcam/haarcascade_frontalface_alt.xml')
global text
...
while True:
    ...
    for f in faces:
        ...
        FaceFileName = "C:/Users/91944/PycharmProjects/test webcam/test.jpg"  # Saving the current image from the webcam for testing.
    ...
    if time.time() > future:##after 20second music will play
        try:
            ...
            mp = '%ProgramFiles(x86)%\Windows Media Player\wmplayer.exe/prefetch:1'
            if text == 'Angry':
